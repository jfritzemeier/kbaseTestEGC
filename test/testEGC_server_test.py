...
from testEGC.testEGCImpl import testEGC
from testEGC.testEGCServer import MethodContext
from testEGC.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class testEGCTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('testEGC'):
        ...
        cls.serviceImpl = testEGC(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_testEGC_" + str(suffix)
